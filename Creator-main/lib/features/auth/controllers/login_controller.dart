...
class LoginController extends StateNotifier<LoginState> {
  ...
  Future<void> signIn(BuildContext context) async {
    ...
    if (email.isEmpty || password.isEmpty) {
      state = const LoginState(errorMessage: 'Please fill in all fields.');
      return;
    }
    ...
    if (mockUsers[email] == password) {
      ...
      state = const LoginState(errorMessage: 'Invalid email or password.');
    }
  }
  ...
  void forgotPassword(BuildContext context) {
    ...
    if (email.isEmpty) {
      state = const LoginState(errorMessage: 'Please enter your email address.');
      return;
    }
    ...
    if (mockUsers.containsKey(email)) {
      ...
      state = const LoginState(errorMessage: 'No account found with this email.');
    }
  }
